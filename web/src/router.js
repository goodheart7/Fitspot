...
import * as Challenges from '@Challenges/scenes';
import * as Enterprise from '@Enterprise/scenes';

import { bookingResetState } from '@store/modules/booking/actions'
  ...
  return (
    <Provider store={store}>
      <Router onUpdate={() => window.scrollTo(0, 0)} history={history}>
        ...
        <Route path="/booking" onLeave={() => store.dispatch(bookingResetState())}>
          ...
          <Route path="choose-subscription/" component={Booking.ChooseSubscriptionScene} />
         ...
         <Route path='/challenges/'>
              <IndexRoute component={Challenges.ChallengesScene} />
              <Route path="challenge-detail/:id" component={Challenges.DetailChallengeScene}/>
              <Route path="create-challenge" component={Challenges.ChallengesCreateScene}/>
             <Route path="edit-challenge/:id" component={Challenges.ChallengeEditScene}/>
          </Route>
          <Route path='/employees/'>
               <IndexRoute component={Enterprise.EmployeesScene} />
              <Route path="add-employee/" component={Enterprise.EmployeesInviteScene}/>
              <Route path="add-departments/" component={Enterprise.AddDepartmentsScene}/>
           </Route>
