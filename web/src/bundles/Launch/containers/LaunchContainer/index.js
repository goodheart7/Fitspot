...
import { setUserTypeCustomer, setUserTypeTrainer, fetchWorkoutsAvailable } from '@store/modules/auth/actions';
...
class LaunchContainer extends Component {
  ...
  componentWillMount() {
      ...
      this.props.fetchWorkoutsAvailable();
  }
  renderPlans() {
