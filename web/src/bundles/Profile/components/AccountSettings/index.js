  ...
  render() {
	...
	<div className="row">
              ...
              <div className="col-xs-12 col-sm-6">
                  ...
                  <p className="text-center">Refer friends or ask for sponsorship from your employer to gain Fitspot Credits for workout sessions!</p>
                  ...
                  <a href="#"
                     ...
                     onClick={() => {
                      events.track("Send Code Clicked", {'media' : 'email'});
                      Actions.refer(this.props.user.publicId);
                     }}
                  >
                      Send Code
                  </a>
