    ...
    return (
          <View style={{ height: 400, width: 280,}}>
            <View style={{
              ...
              <Button buttonStyle={styles.modalButton}
                      ...
                      buttonName={"Refer Friend"}
                      eventProps={{'media' : 'email'}}
              >
                Send To Friends
              </Button>
              {/* TODO need text and social messages as well? */}
              ...
              <Button buttonTextStyle={styles.modalButtonText}
                      onPress={() => Linking.openURL(giftCardURL)} buttonStyle={[styles.modalButton,{marginBottom:20}]}
