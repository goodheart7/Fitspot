  ...
  render(){
    ...
    return (
      <View style ={styles.row}>
        ...
        <View style={[styles.rowBottom,{marginTop:0}]}>
          <TouchableHighlight onPress={()=> Actions.editBookingHome({workoutItem: eventInfo})} underlayColor='rgba(0,0,0,0)' style={[styles.rowBottomColumn, {flex:1,marginRight: 0,backgroundColor:DEFAULT_GREEN_COLOR,height:40}]}>
          ...
          <TouchableHighlight onPress={()=> this.chat()} underlayColor='rgba(0,0,0,0)' style={[styles.rowBottomColumn, {flex:1,borderLeftWidth: 1, borderLeftColor: '#c0c0c0', marginRight: 0,backgroundColor:DEFAULT_GREEN_COLOR, height:40}]}>
            <View style={{alignSelf:'center',flexDirection:'row',}}>
