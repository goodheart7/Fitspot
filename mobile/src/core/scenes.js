...
import {TrainerAboutYouScene, TrainerInformationScene, CustomerAboutYouScene} from '@LoginRegistration/scenes'
  ...
  <Scene key="root">
    <Scene key="modal" component={Modal} >
      <Scene  key="myTabBar" tabs tabBarStyle={{alignItems: 'center',justifyContent: 'center', alignSelf:'center',backgroundColor: '#ffffff'}}>
          ...
          <Scene key="customerAboutYou" title='About You' component={CustomerAboutYouScene} hideNavBar hideTabBar/>
