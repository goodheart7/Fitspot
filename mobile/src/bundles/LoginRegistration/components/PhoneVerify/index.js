    ...
    render(){
      return (
        <View style={styles.container}>
          ...
          <HorizontalLine/>
          <TextInput style={styles.textInput} placeholder='SMS Code (ex: 359 843)' keyboardType='numeric' placeholderTextColor='#cccccc' value={this.state.number} onChangeText={(text) => this.setState({number: text})}/>
          <HorizontalLine/>
