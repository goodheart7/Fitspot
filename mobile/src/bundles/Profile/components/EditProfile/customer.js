  ...
  updatePhoto(){
    ...
    ImagePicker.showImagePicker(options, (response) => {
      ...
      if (response.didCancel) {
        ...
        events.track('Uploaded Profile Picture');
      }
    });
  }
  ...
  render (){
    ...
    return (
      ...
      <KeyboardAwareScrollView style={{marginBottom:55}} contentContainerStyle={{marginTop:63,marginBottom: 55}}>
        ...
        <Button buttonStyle={[styles.buttonStyle,{marginTop:25}]} buttonTextStyle={styles.buttonTextStyle} onPress={Actions.fitnessGoals} track>
          Change Fitness Goals
        </Button>
        <Button buttonStyle={[styles.buttonStyle]} buttonTextStyle={styles.buttonTextStyle} onPress={Actions.bodyFocus} track>
          Change Body Focus
        </Button>
        <Button buttonStyle={styles.buttonStyle} buttonTextStyle={styles.buttonTextStyle} onPress={Actions.trainingCadence} track>
          Change Fitness Level
        </Button>
        <Button buttonStyle={[styles.buttonStyle]} buttonTextStyle={styles.buttonTextStyle} onPress={Actions.trainerStyles} track>
          Change Training Style
        </Button>
        <Button buttonStyle={[styles.buttonStyle]} buttonTextStyle={styles.buttonTextStyle} onPress={Actions.favHighIntensity} track>
          Change High Intensity Workouts
        </Button>
        <Button buttonStyle={[styles.buttonStyle]} buttonTextStyle={styles.buttonTextStyle} onPress={Actions.favLowIntensity} track>
