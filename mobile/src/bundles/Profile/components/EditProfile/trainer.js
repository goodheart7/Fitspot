...
class EditTrainerProfile extends React.Component{
  ...
  onLocationEnter(){
    const trainer = this.state.user.trainer;
    var address = trainer.address + ' ' + trainer.city + ' ' + trainer.state + ' ' + trainer.zipcode;
    //console.log(address);
          ...
          <HorizontalLine/>
            <View style={styles.locationEntryView}>
              <View style={styles.locationInputContainer}>
                ...
                <TextInput style={{flex:1, backgroundColor:'red',fontFamily: 'System',
                fontSize: 12,
                backgroundColor:'rgba(0,0,0,0)',height:45}} placeholder='Zip' returnKeyType='search' placeholderTextColor='#c0c0c0'  onEndEditing={() => this.onLocationEnter()} onChangeText={(text) => this.updateText("zipcode",text)} value={user.trainer.zipcode}/>
                </View>
              </View>
            </View>
