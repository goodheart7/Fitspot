...
import { fetchWorkouts, fetchTrainerWorkouts } from '@store/modules/workouts/actions'
...
class HomeContainer extends Component {
  ...
  componentWillMount() {
    if(this.state.user.userType == CONSTS.USER_TYPE.TRAINER) {
      this.props.getWorkoutInfo();
      if (!this.state.user.userProfileReady) {
        Actions.trainerAboutYou();
      }
    } else if(this.state.user.userType == CONSTS.USER_TYPE.CUSTOMER) {
