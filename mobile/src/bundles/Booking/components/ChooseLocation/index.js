  ...
  render() {
    ...
    return (
      ...
      <NavigationSteps currentNumber={this.state.currentStep} style={{opacity: this.props.bookingState.isEditing ? 0 : 1}} numberOfSteps={this.state.totalSteps}  />
        <ChooseLocationListView visible={showListView} locationItems={ locationItems } chooseLocation={this.chooseLocation.bind(this)} bookingState={this.props.bookingState} />
        <ChooseLocationMapView addLocation={this.props.addLocation} visible={!showListView} locationItems={ locationItems } chooseLocation={this.chooseLocation.bind(this)} locationPermission={locationPermission} bookingState={this.props.bookingState} />
